# aws-aurora-serverless-sample

This is a sample template for aws-aurora-serverless-sample - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-aurora-serverless-sample \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-aurora-serverless-sample --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-aurora-serverless-sample
```
